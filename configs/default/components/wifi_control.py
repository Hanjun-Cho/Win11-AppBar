...
class WifiControlLabel(ClickableImageLabel):
    def __init__(self, size):
        current_dir = os.path.dirname(os.path.abspath(__file__))
        src_dir = current_dir + "./../src/wifi/"
        self.icon_dir = src_dir + "wifi.svg"
...
def get_widget(layout_config) -> QWidget:
    widget = WifiControlLabel(layout_config[LayoutFields.WINBAR_COMPONENT_HEIGHT])
    return widget
